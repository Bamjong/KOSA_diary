...
@WebServlet(
      ...
      initParams = { 
            ...
            @WebInitParam(name = "jdbcDriver", value = "oracle.jdbc.OracleDriver", description = "오라클 드라이버")
      })
public class NowServlet extends HttpServlet {
   private static final long serialVersionUID = 1L;
    ...
    public NowServlet() {
        super();
        System.out.println("생성자는 객체 생성시 한번만 호출");
    }
   ...
   public void init(ServletConfig config) throws ServletException {
      ...
      //유관순 세번째 접속자 -> it.co.kr/Now.do 서버 요청
      //class >> 실행 -> doGET or doPOST -> 자동호출
