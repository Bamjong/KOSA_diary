...
<!-- 
	Server 웹 서버(WAS)
		1. server memory: session객체 (사이트 접속하는 [사용자]마다 [고유]하게 무여하는 메모리(객체)) > 서버 리부팅,개발코드변경 > 소멸 > 생성
		2. server memory: application객체 (사이트 접속하는 [모든 사용자]에게 고유하게 무여하는 메모리(객체)) > 서버 리부팅,개발코드변경 > 소멸 > 생성
