...
public class Ex13_Map_Interface {
	public static void main(String[] args) {
		...
		System.out.println(map.containsKey("Scott")); //대소문자 구별 (true)
		System.out.println(map.containsValue("1004"));//중복상관없어요 (true)
		
		System.out.println(map.get("Tiger")); // 1004
		//key제공 >> value >> map.get(key)
		System.out.println(map.get("hong"));  // 없는 key return null;
		
		map.put("Tiger", "1008"); // value repalce
		System.out.println(map.get("Tiger")); // 1008
		System.out.println(map.size()); //3
		
		System.out.println(map);//재정의 key,value 확인 가능
